...
const Profile = () => {
    ...
    const userData = async () => {
      try {
        const res = await fetch(
          'https://partners-in-crime-backend-production.up.railway.app/fetchuserprofile',
          {
            headers: {
      ...
      if (image) {
        ...
        try {
          ...
          if (res.status === 200) {
            ...
            try {
              res = await fetch(
                'https://partners-in-crime-backend-production.up.railway.app/updateuserpic',
                {
                  method: 'PUT',
                  headers: {
                    'Content-Type': 'application/json',
  ...
  const updateUserData = async () => {
    try {
      ...
      const res = await fetch(
        'https://partners-in-crime-backend-production.up.railway.app/updateuserprofile',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
