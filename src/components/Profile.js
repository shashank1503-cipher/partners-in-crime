...
const Profile = () => {
    ...
    const userData = async () => {
      try {
        const res = await fetch(
          'https://partners-in-crime.herokuapp.com/fetchuserprofile',
          {
            headers: {
      ...
      if (image) {
        ...
        try {
          ...
          if (res.status === 200) {
            ...
            try {
              res = await fetch(
                'https://partners-in-crime.herokuapp.com/updateuserpic',
                {
                  method: 'PUT',
                  headers: {
                    'Content-Type': 'application/json',
  ...
  const updateUserData = async () => {
    try {
      ...
      const res = await fetch(
        'https://partners-in-crime.herokuapp.com/updateuserprofile',
        {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
